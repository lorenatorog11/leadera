...
class RememberPassword extends Component {
  render (){
    ...
    const type = 'text';
    const placeholder = '';
    const labelBtn = 'RECUPERAR CONTRASEÑA';

    return (
      <div className="app">
        <div className="peers ai-s fxw-nw h-100vh">
          <div className="col-12 col-sm-5 peer pL-40 pR-160 pY-100 h-100 bgc-white scrollable pos-r" style={{minWidth: '320px'}}>
            <h2 className="fw-bold c-grey-900 mT-40 lh-sm">RECUPERAR CONTRASEÑA</h2>
            <p className="mY-30 lh-sm hyphens">Te enviaremos un correo electrónico con las instrucciones para reiniciar tu contraseña. Si este proceso no funciona por favor comunícate con nuestra línea de atención Leadera.</p>
            <form>
              <div className="mb-3">
              ...
              <div className="col-12 p-0 my-4 d-flex justify-content-between">
                ...
                <Link to='/refresh-password'><Btn labelBtn={labelBtn}/></Link>
                </div>
