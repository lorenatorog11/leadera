...
class RememberUser extends Component {
  render (){
    const label = 'Recuperar usando el email de tu cuenta';
    const type = 'email';
    const placeholder = 'Ejm: andres@leadera.com';
    const labelBtn = 'RECUPERAR';

    return (
      <div className="app">
        <div className="peers ai-s fxw-nw h-100vh">
          <div className="col-12 col-sm-5 peer pL-40 pR-160 pY-100 h-100 bgc-white scrollable pos-r" style={{minWidth: '320px'}}>
            <h2 className="fw-bold c-grey-900 mT-40 lh-sm">RECUPERAR NOMBRE DE USUARIO</h2>
            <p className="mY-30 lh-sm hyphens">Puedes recuperar tu nombre de usuario usando el email asociado a tu cuenta de Leadera</p>
            <form>
              <div className="mb-3">
